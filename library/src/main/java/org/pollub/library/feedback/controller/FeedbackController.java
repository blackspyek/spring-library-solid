package org.pollub.library.feedback.controller;
...
import org.pollub.library.feedback.model.dto.FeedbackAdminDto;
import org.pollub.library.feedback.model.dto.FeedbackRequestDto;
import org.pollub.library.feedback.model.dto.FeedbackResponseDto;
import org.pollub.library.feedback.service.IFeedbackService;
    ...
    public ResponseEntity<FeedbackResponseDto> submitFeedback(
        ...
        if (userDetails != null) {
            try {
                ...
                // Continue as anonymous if user lookup fails
            }
        }
        ...
        Feedback saved = feedbackService.submitFeedback(dto, user, ipAddress);
